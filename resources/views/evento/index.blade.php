...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-9 col-sm-12 col-md-12 col-lg-8 d-none d-sm-block">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <label for="hora" class="col-3 col-sm-2 control-label col-form-label mt-2">Hora:</label>
                                <div class="col-9 col-sm-3">
                                    <input type="time" class="form-control mt-2" name="hora" id="hora" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="tema" class="col-3 control-label col-form-label">Titulo:</label>
                                <div class="col-9">
                                    <input type="text" class="form-control" name="tema" id="tema" placeholder=""
                                        required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-9">
                                    <div class="form-check form-switch mt-2">
                                        <input id="ctrAsistencia" class="form-check-input rounded-pill" type="checkbox"
                                            role="switch" name="ctrAsistencia">
...
<div class="modal fade" id="modalVistaPrev" tabindex="-1" aria-labelledby="modalVistaPrevLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
